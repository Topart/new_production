 ...
 * @author   Mike Whitby <me@mikewhitby.co.uk>
 */
class Onetree_Seo_Block_Adminhtml_Setting_Edit extends Mage_Adminhtml_Block_Widget_Form_Container
{
    /**
     * Class constructor
     */
    public function __construct()
    {
        ...
        $this->_controller = 'adminhtml_setting'; # same as the grid container
        $this->_blockGroup = 'onetree_seo'; # same as the grid container
        $this->_updateButton('save', 'label', Mage::helper('onetree_seo')->__('Save Thing')); # sets the text for the save button
        $this->_updateButton('delete', 'label', Mage::helper('onetree_seo')->__('Delete Thing')); # sets the text for the delete button
        # adds a save and continue edit button, not needed but nice
        $this->_addButton(
            'save_and_edit_button',
            array(
                'label'     => Mage::helper('onetree_seo')->__('Save and Continue Edit'),
    ...
    public function getHeaderText()
    {
        ...
        if (Mage::registry('setting_data') && Mage::registry('setting_data')->getId() ) {
            return Mage::helper('onetree_seo')->__("Edit Thing");
        } else {
            return Mage::helper('onetree_seo')->__('Add Thing');
        }
    }
