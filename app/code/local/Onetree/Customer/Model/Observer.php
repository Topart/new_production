...
class Onetree_Customer_Model_Observer
{
    ...
    {
        $observer->getAccountController()->getLayout()->getUpdate()
           ->addHandle('customer_first_time');
    ...
    public function beforeLoadLayout1($observer)
    {
        $firstTime = Mage::getSingleton( 'customer/session' )->getFirstTime();
